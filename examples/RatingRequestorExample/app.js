...
import RatingRequestor, { RatingsData } from 'react-native-rating-requestor';
const RatingTracker = new RatingRequestor('123456789', '123456789', { eventsUntilPrompt: 3 });

class RatingRequestorExample extends Component {
	constructor() {
		super()
		this.state = {
